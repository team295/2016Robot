...
public class Robot extends IterativeRobot {
    ...
    public void teleopPeriodic() {
		...
		if(isSpeedMode) {
			_talon.set(Math.pow(UtilityFunctions.deadband(driver.getRawAxis(1)), 3) * 80000);
		} else {
		...
		_talon2.set(Math.pow(UtilityFunctions.deadband(driver.getRawAxis(3)), 3) * 80000);
	}
	...
	public void teleopInit() {
		...
		_talon2.changeControlMode(CANTalon.TalonControlMode.Speed);
		_talon2.reverseSensor(false);

		_talon2.configNominalOutputVoltage(+0.0f, -0.0f);
		_talon2.configPeakOutputVoltage(+12.0f, -12.0f);
		//_talon.reverseOutput(true);
		//_talon.configEncoderCodesPerRev(1000);
		
		_talon2.setProfile(1); //Speed
		_talon2.setF(0.005);
		_talon2.setP(0.02);
		_talon2.setI(0); 
		_talon2.setD(0.01);
